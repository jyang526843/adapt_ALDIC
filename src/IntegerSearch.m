...
% ==============================================
function [SizeOfFFTSearchRegion,x0,y0,u,v,cc,gridx,gridy]= IntegerSearch(gridxROIRange,gridyROIRange,fNormalized,gNormalized,winsize,winstepsize,file_name)
...
while InitialGuessSatisfied == 1
    ...
    if tempNoOfInitPt ~= 1  
        ...
        [x0,y0,u,v,cc,gridx,gridy] = funIntegerSearch(fNormalized,gNormalized,tempSizeOfSearchRegion,gridxROIRange,gridyROIRange,winsize,winstepsize,tempNoOfInitPt,winstepsize);
