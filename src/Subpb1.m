...
function [USubpb1,HPar,ALSub1Time,ConvItPerEle] = Subpb1(USubpb2,FSubpb2,udual,vdual,coordinatesFEM,...
    Df,imgfNormalizedbc,imggNormalizedbc,winsize,mu,beta,HPar,ALSolveStep,tol,ICGNmethod,ClusterNo)
        ...
        for tempj = 1:size(coordinatesFEM,1)  % tempj is the element index
            ...
            try
                [Utemp, Htemp, ConvItPerEle(tempj,:)] = ...
                    funICGN_Subpb1(x0temp,y0temp,Df,imgfNormalizedbc,imggNormalizedbc,winsize*ones(1,2),...
