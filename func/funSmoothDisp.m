...
% ==============================================
function ULocal = funSmoothDisp(ULocal,coordinatesFEM,elementsFEM,x,y,winstepsize,varargin)
% ,FilterSizeInput,FilterStd,LevelNo )
FilterStd = []; FilterSizeInput = []; LevelNo = 1; 
switch nargin
    case 7
