...
while ClearBadInitialPointsOrNot == 0
    ...
    BadptRow=[BadptRow;row]; BadptCol=[BadptCol;col]; 
    [tempindex1] = find(BadptRow<1+size(u,1));  [tempindex2] = find(BadptCol<1+size(u,2));
    [tempindex3] = find(BadptRow>0);  [tempindex4] = find(BadptCol>0);
