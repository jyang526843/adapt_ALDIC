...
rhoLevel1Vector = ones(size(elementsFEM,1),1); rhoLevel1Vectortemp1 = rhoLevel1Vector; rhoLevel1Vectortemp2 = rhoLevel1Vector;
ULevel1temp = [ULevel1;0;0]; imgPyramidUnit = 1; EstimateTime=0; MarkTime=0; RefineTime=0;
% try
...
while DorflerSatisfied == 1
    ...
    %thetaDorflerList(LevelNo) = thetaDorfler; 
