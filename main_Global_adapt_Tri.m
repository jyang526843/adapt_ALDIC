...
for ImgSeqNum = 2:length(ImgNormalized)
    ...
    tol = 1e-4; alphavar = 5; GaussPtOrder = 2; LevelNo = 1; clusterNo = 2; tic; 
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    [ULevel1, normOfW, TimeICGN] = funGlobalICGNTri(coordinatesFEM,elementsFEM,Df,fNormalized,gNormalized,U0,alphavar,tol,clusterNo);
    [FLevel1] = funGlobal_CSTStrain(coordinatesFEM,elementsFEM,ULevel1);
    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    while (LevelNo<6) && (winstepsize/(2^(LevelNo-1))>1) && (mod((winstepsize/(2^(LevelNo-1))),2)==0)
        ...
        % ============== ALMS iteration ===============
        close all; DispFilterSize=0; DispFilterStd=0; StrainFilterSize=0; StrainFilterStd=0;  
        [UIter,FIter,alphaIter,normOfWIter,...
            coordinatesFEMIter,elementsFEMIter,eleGenerationIter,dirichletIter,neumannIter,...
            ...
            = funGBMSIterTri(UIter,FIter,coordinatesFEMIter,elementsFEMIter,winstepsize,ClusterNo,...
